# 2026-fwdays-agentic-greenfield-task — Agent Rules
...
# This may NOT be the TBD you know

The installed version (TBD) may differ from training data.
Read the relevant guide in `node_modules/TBD/dist/docs/` (or the
...
- macOS (darwin), zsh
- Database: TBD — to be decided in Phase 1 stack selection
